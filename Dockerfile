...
RUN cd /tmp \
    ...
    && apt-get install -yq php7.0-mbstring php7.0-cgi php7.0-cli php7.0-dev php7.0-geoip php7.0-common php7.0-xmlrpc php7.0-sybase php7.0-curl \
        php7.0-enchant php7.0-imap php7.0-xsl php7.0-mysql php7.0-mysqli php7.0-mysqlnd php7.0-pspell php7.0-gd php7.0-zip \
        php7.0-tidy php7.0-opcache php7.0-json php7.0-bz2 php7.0-pgsql php7.0-readline php7.0-imagick php7.0-phar \
        php7.0-intl php7.0-sqlite3 php7.0-ldap php7.0-xml php7.0-redis php7.0-fpm \
        php7.0-soap php7.0-bcmath php7.0-fileinfo php7.0-xdebug php7.0-exif php7.0-tokenizer \
    && apt-get install -yq php7.1-mbstring php7.1-cgi php7.1-cli php7.1-dev php7.1-geoip php7.1-common php7.1-xmlrpc php7.1-sybase php7.1-curl \
        ...
        php7.1-tidy php7.1-opcache php7.1-json php7.1-bz2 php7.1-pgsql php7.1-readline php7.1-imagick php7.1-phar \
        php7.1-intl php7.1-sqlite3 php7.1-ldap php7.1-xml php7.1-redis php7.1-fpm \
    ...
    && apt-get install -yq php5.6-mbstring php5.6-cgi php5.6-cli php5.6-dev php5.6-geoip php5.6-common php5.6-xmlrpc php5.6-sybase php5.6-curl \
        ...
        php5.6-tidy php5.6-opcache php5.6-json php5.6-bz2 php5.6-pgsql php5.6-readline php5.6-imagick php5.6-phar \
        php5.6-intl php5.6-sqlite3 php5.6-ldap php5.6-xml php5.6-redis php5.6-fpm \
        php5.6-soap php5.6-bcmath php5.6-fileinfo php5.6-xdebug php5.6-exif php5.6-tokenizer \

    && apt install -yq vsftpd htop \
...
# PHP
    && apt-get install -yf --no-install-recommends libapache2-mod-php7.0 libapache2-mod-php7.1 libapache2-mod-php5.6 \
...
#    && a2enmod headers && a2dismod php7.3 && a2dismod php7.4 && a2enmod php7.2 \
    && a2enmod headers && a2dismod php7.3 && a2dismod php7.4 && a2enmod php7.2 && a2dismod php7.1 && a2dismod php7.0 && a2dismod php5.6 \
...
# disable localhost redirect to bad default IP
    ...
    && service vsftpd stop && systemctl disable vsftpd \
